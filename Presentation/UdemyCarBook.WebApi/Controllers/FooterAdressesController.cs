...
namespace UdemyCarBook.WebApi.Controllers
{
    ...
    public class FooterAdressesController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateFooterAdress(CreateFooterAdressComand command)
        {
            await _mediator.Send(command);
            return Ok("Alt Adress Bilgisi Olusturuldu.");
        }
        ...
        [HttpPut]
        public async Task<IActionResult> UpdateFooterAdress(UpdateFooterAdressCommand cmd)
        {
